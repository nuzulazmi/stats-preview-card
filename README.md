...
- Live Site URL: (https://nuzulazmi.github.io/stats-preview-card/)
...
I've learned several ways to use flexbox properties in CSS, and I'm implementing them in this project,
This is an example of CSS flexbox I just applied:
...
```
Note: property "flex-direction" will only work if the parent element is given the property "display: grid;".
The "flex-direction" property has several values ​​including: "column, column-reverse, row, row-reverse.
...
- [Google Font](https://fonts.google.com/) - A lot of you guys probably already know this resource, this is Google Font, you can find a lot of fonts and styles for your project here. Go check it out!...
